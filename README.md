...
* [sstable-tools-3.0.0-alpha5.jar](https://bintray.com/artifact/download/tolbertam/sstable-tools/sstable-tools-3.0.0-alpha5.jar) -  Currently tested with 3.0, 3.1, 3.1.1, 3.2.1, 3.3, 3.4.
